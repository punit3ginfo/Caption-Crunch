...
(function($) {
	$(document).ready(function() {
		var data="<div class='loading-clearfix'><div class='loading-container'><img class='loading-img' src='images/loading13.gif' /><span class='cc-text-small'>Loading</span></div></div>";
     $('.content-container').html(data);
