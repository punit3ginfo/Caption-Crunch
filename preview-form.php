                      ...
                      <div class="caption-show-hide">
                              <div class="form-clearfix">
                                      <div class="form-caption-list-clearfix">
                                          <a href="javascript:void(0)" class="button-three-col green-button">Caption Title</a>
                                          <a href="javascript:void(0)" class="button-three-col grey-button">Caption Title</a>
                                          <a href="javascript:void(0)" class="button-three-col grey-button">Caption Title</a>
                                          <a href="javascript:void(0)" class="button-three-col grey-button">Caption Title</a>
                                          <a href="javascript:void(0)" class="button-three-col grey-button">Caption Title</a>
                                          <a href="javascript:void(0)" class="button-three-col grey-button">Caption Title</a>
