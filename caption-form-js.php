...
$('.add-condition-button').click(function(){
		$("#add-condition-container").before("<div class='form-clearfix'><div class='form-3col-clearfix'><select class='form-select'><option>Collection Title</option><option>Product Title</option><option>Product Type</option><option>Product Vendor</option><option>Product Price</option><option>Product Tag</option><option>Compare At Price</option><option>Weight</option><option>Inventory Stock</option><option>Varient Title</option></select></div></div>");
});
