				...
				<div class="product-card-container">
					...
					$(document).ready(function() {
						...
						$('#share-button-<?php echo $p_id1; ?>').click(function() {
							...
							var $CaptionOneFB = 'Grab1 the <?php echo str_replace("'","\'",$title); ?> for ONLY $<?php echo $price; ?>! (Retail $<?php echo $ComparePrice; ?>) Get it here: <span style="color: #365899;">http://buff.ly/2fVq7rY</span>';
							...
							var $CaptionOne = 'Grab2 the <?php echo htmlspecialchars($title, ENT_NOQUOTES); ?> for ONLY $<?php echo $price; ?>! (Retail $<?php echo $ComparePrice; ?>) Get it here: http://buff.ly/2fVq7rY';
