                	...
                	<div class="chat_selector_overflow_container">
       				...
       				require __DIR__.'/get_collectionlist.php'; //GET PRODUCTS
						...
						<?php 
						 ...
						 ?>
												 <button type="button" id="showLess"><i class="fa fa-arrow-left"></i></button> <ul id="pagination-list">
						  ...
						  <?php } ?>
						   ...
						   <button type="button" id="loadMore"><i class="fa fa-arrow-right"></i></button>
